...
(function ($) {
  ...
  $('.menu-item a, .dropdown button').on('keyup', function (e) {
    ...
    if (isSubMenuDropdownOpen === 'true' || isMainMenuDropdownOpen === 'true') {
      ...
      // Close menu using Esc key but only if dropdown is open
        if (e.code === 'Escape') {
          ...
          // jscs:enable
          screenReaderSpan.text(air-blocks_screenReaderText.expand);
    ...
    if (window.innerWidth > responsivenav) {
      ...
      screenReaderSpanPrev.text(air-blocks_screenReaderText.expand);
      ...
      screenReaderSpanNext.text(air-blocks_screenReaderText.expand);
    }
  });
  ...
  $('.dropdown-toggle').each(function () {
    $(this).attr('aria-label', `${air-blocks_screenReaderText.expand_for} ${$(this).prev().text()}`);
  });
  ...
  siteHeaderMenu.find('.dropdown-toggle').on('click', function (e) {
    ...
    $(this).attr(
      'aria-label',
      $(this).attr('aria-label') === `${air-blocks_screenReaderText.collapse_for} ${$(this).prev().text()}`
        ? `${air-blocks_screenReaderText.expand_for} ${$(this).prev().text()}`
        : `${air-blocks_screenReaderText.collapse_for} ${$(this).prev().text()}`,
    );
  });
  ...
  function mobileNav() {
    ...
    menuToggle.on('click', function () {
      ...
      $('#nav-toggle-label').text(
        ...
        $('#nav-toggle-label').text() === air-blocks_screenReaderText.expand_toggle
          ? air-blocks_screenReaderText.collapse_toggle
          : air-blocks_screenReaderText.expand_toggle,
      );

      $(this).attr(
        'aria-label',
        $(this).attr('aria-label') === air-blocks_screenReaderText.expand_toggle
          ? air-blocks_screenReaderText.collapse_toggle
          : air-blocks_screenReaderText.expand_toggle,
      );
