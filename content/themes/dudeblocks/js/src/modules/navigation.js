...
(function ($) {
  ...
  $('.menu-item a, .dropdown button').on('keyup', function (e) {
    ...
    if (isSubMenuDropdownOpen === 'true' || isMainMenuDropdownOpen === 'true') {
      ...
      // Close menu using Esc key but only if dropdown is open
        if (e.code === 'Escape') {
          ...
          // jscs:enable
          screenReaderSpan.text(dudeblocks_screenReaderText.expand);
    ...
    if (window.innerWidth > responsivenav) {
      ...
      screenReaderSpanPrev.text(dudeblocks_screenReaderText.expand);
      ...
      screenReaderSpanNext.text(dudeblocks_screenReaderText.expand);
    }
  });
  ...
  $('.dropdown-toggle').each(function () {
    $(this).attr('aria-label', `${dudeblocks_screenReaderText.expand_for} ${$(this).prev().text()}`);
  });
  ...
  siteHeaderMenu.find('.dropdown-toggle').on('click', function (e) {
    ...
    $(this).attr(
      'aria-label',
      $(this).attr('aria-label') === `${dudeblocks_screenReaderText.collapse_for} ${$(this).prev().text()}`
        ? `${dudeblocks_screenReaderText.expand_for} ${$(this).prev().text()}`
        : `${dudeblocks_screenReaderText.collapse_for} ${$(this).prev().text()}`,
    );
  });
  ...
  function mobileNav() {
    ...
    menuToggle.on('click', function () {
      ...
      $('#nav-toggle-label').text(
        ...
        $('#nav-toggle-label').text() === dudeblocks_screenReaderText.expand_toggle
          ? dudeblocks_screenReaderText.collapse_toggle
          : dudeblocks_screenReaderText.expand_toggle,
      );

      $(this).attr(
        'aria-label',
        $(this).attr('aria-label') === dudeblocks_screenReaderText.expand_toggle
          ? dudeblocks_screenReaderText.collapse_toggle
          : dudeblocks_screenReaderText.expand_toggle,
      );
