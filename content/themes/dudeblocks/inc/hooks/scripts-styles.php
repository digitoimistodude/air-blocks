...
} // end dudeblocks_move_jquery_into_footer
...
function enqueue_theme_scripts() {
  ...
  wp_localize_script( 'scripts', 'dudeblocks_screenReaderText', [
  ...
  wp_localize_script( 'scripts', 'dudeblocks_externalLinkDomains', [
      'localhost:3000',
      'dudeblocks.test',
      'dudeblocks.fi',
  ] );
} // end dudeblocks_scripts
...
function enqueue_polyfills() {
  ...
  if ( file_exists( get_theme_file_path( get_asset_file( 'legacy.js' ) ) ) ) {
    wp_register_script( 'dudeblocks_legacy', '', [], filemtime( get_theme_file_path( get_asset_file( 'legacy.js' ) ) ), false );
    wp_enqueue_script( 'dudeblocks_legacy' );
    wp_add_inline_script( 'dudeblocks_legacy', $script, true );
  }
