...
add_action( 'after_setup_theme', function() {
  $theme_settings = [
     ...
     */
    'menu_locations' => [
      'primary' => __( 'Primary Menu', 'dudeblocks' ),
    ],
     ...
     * https://github.com/digitoimistodude/dudeblocks#custom-taxonomies
     */
    'taxonomies' => [
      // 'your-taxonomy' => [
      //   'name' => 'Your_Taxonomy',
     ...
     *
     * See the instructions:
     * https://github.com/digitoimistodude/dudeblocks#custom-post-types
     */
    'post_types' => [
  ...
  $theme_settings = apply_filters( 'dudeblocks_theme_settings', $theme_settings );
