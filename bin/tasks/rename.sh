...
mv ${PROJECT_THEME_PATH}/assets/src/sass/gutenberg/blocks/_${BLOCK_SLUG}.scss ${PROJECT_THEME_PATH}/assets/src/sass/gutenberg/blocks/_${BLOCK_SLUG_TO_RENAME_TO}.scss
...
sed -i '' -e "s;@import 'gutenberg/blocks/${BLOCK_SLUG}';@import 'gutenberg/blocks/${BLOCK_SLUG_TO_RENAME_TO}';" ${PROJECT_THEME_PATH}/assets/src/sass/gutenberg/_blocks.scss
