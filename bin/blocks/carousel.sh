...
cp -nv ${AIRBLOCKS_THEME_PATH}/js/src/modules/carousel.js ${PROJECT_THEME_PATH}/assets/src/js/modules/carousel.js

# Import js modules
sed -e "/\/\/ Import modules/a\\
import initCarousel from './modules/carousel';" < ${PROJECT_THEME_PATH}/assets/src/js/front-end.js > ${PROJECT_THEME_PATH}/assets/src/js/front-end-with-changes.js
...
initCarousel();" < ${PROJECT_THEME_PATH}/assets/src/js/front-end.js > ${PROJECT_THEME_PATH}/assets/src/js/front-end-with-changes.js
rm ${PROJECT_THEME_PATH}/assets/src/js/front-end.js
mv ${PROJECT_THEME_PATH}/assets/src/js/front-end-with-changes.js ${PROJECT_THEME_PATH}/assets/src/js/front-end.js

# Add carousel settings code to gutenberg-editor.js
sed -e "/modules\/gutenberg-helpers\'\;/a\\
import initCarousel from \'\.\/modules\/carousel\'\;\\" < ${PROJECT_THEME_PATH}/assets/src/js/gutenberg-editor.js | tr '§' '\n' > ${PROJECT_THEME_PATH}/assets/src/js/gutenberg-editor-changes.js
rm ${PROJECT_THEME_PATH}/assets/src/js/gutenberg-editor.js
mv ${PROJECT_THEME_PATH}/assets/src/js/gutenberg-editor-changes.js ${PROJECT_THEME_PATH}/assets/src/js/gutenberg-editor.js

# Init carousel inside initializeBlock function
sed -e "/airblocks_LazyLoad.update();/a\\
    initCarousel\(\)\;" < ${PROJECT_THEME_PATH}/assets/src/js/gutenberg-editor.js | tr '§' '\n' > ${PROJECT_THEME_PATH}/assets/src/js/gutenberg-editor-changes.js
rm ${PROJECT_THEME_PATH}/assets/src/js/gutenberg-editor.js
mv ${PROJECT_THEME_PATH}/assets/src/js/gutenberg-editor-changes.js ${PROJECT_THEME_PATH}/assets/src/js/gutenberg-editor.js
